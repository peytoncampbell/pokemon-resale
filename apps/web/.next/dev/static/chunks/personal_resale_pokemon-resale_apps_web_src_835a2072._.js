...
"[project]/personal/resale/pokemon-resale/apps/web/src/lib/justtcg-api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/personal/resale/pokemon-resale/apps/web/src/lib/justtcg-api.ts [app-client] (ecmascript)");
;
;
...
function fromJustTCG(card, gameType) {
    return {
        ...
        imageSmall: __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["justTCGApi"].getImageUrl(card),
        rarity: card.rarity,
        marketPrice: __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["justTCGApi"].getMarketPrice(card)
    };
}
const cardApi = {
    async searchCards (query, gameType) {
        ...
        const gameId = __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JUSTTCG_GAMES"][gameType];
        const cards = await __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["justTCGApi"].searchCards(query, gameId);
        return {
    ...
    async getRecentCards (gameType) {
        ...
        // Use JustTCG for One Piece
        const gameId = __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JUSTTCG_GAMES"][gameType];
        const cards = await __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["justTCGApi"].getRecentCards(gameId);
        return {
            data: cards.map((card)=>fromJustTCG(card, gameType)),
            totalCount: cards.length
        };
    ...
    async getCard (id, gameType) {
        ...
        // Use JustTCG for One Piece
        const card = await __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$justtcg$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["justTCGApi"].getCard(id);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useAnalytics.useQuery": async ()=>{
                ...
                const { data: inventory, error: invError } = await __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('inventory').select('*').eq('organization_id', orgId);
                if (invError) throw invError;
                // Get all sales
                const { data: sales, error: salesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('sales').select('*').eq('organization_id', orgId);
...
//# sourceMappingURL=personal_resale_pokemon-resale_apps_web_src_835a2072._.js.map