    ...
    try {
        const response = await fetch(url, {
            headers: {
                ...
                'User-Agent': 'Pokemon-Resale-App/1.0'
            }
        });
        console.log('One Piece API proxy - response status:', response.status);
        if (!response.ok) {
            const errorText = await response.text();
            console.error('One Piece API proxy - error response:', errorText);
        ...
        console.error('One Piece API proxy error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$personal$2f$resale$2f$pokemon$2d$resale$2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b015e0c7._.js.map